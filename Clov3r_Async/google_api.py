...
class Googlesearch:
    def __init__(self, count_file='search_count.txt'):
        self.api_key = "AIzaSyADd48_1HRNxPf2dtQwnnG38345e7tQg3k" # This is the API key needed, usually provided by Google.
        self.youtube_api_key = "AIzaSyBYmiMXJunZXnSovbRIoYszlgf9V_YQCu8"
        self.bot_id = "9079fbfe18f5543fa" # This is the search engine ID from your google console

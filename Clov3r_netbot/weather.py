...
class WeatherSnag:
    ...
    async def get_weather(self, location):
        ...
        if lat is None or lon is None:
            response = f"Unable to get latitude and longitude for the location: {location}."
            return response
        ...
        try:
            ...
            response = f"No forecast available for location: {location}."
            return response
            
        except Exception as e:
            print("An error occurred:", e)
            response = f"An error occurred while fetching weather information."
            return response
